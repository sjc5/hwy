...
gmpdTester({
  ...
  expectedOutput: {
    matchingPaths: [
      ...
      {
        pathType: "index",
        // filePath: "pages/dashboard/customers/$customer_id/orders/_index.page.tsx", // orders INDEX
      },
    ],
    params: {
      customer_id: "123",
...
gmpdTester({
  ...
  expectedOutput: {
    matchingPaths: [
      ...
      {
        pathType: "dynamic-layout",
        // filePath: "pages/dashboard/customers/$customer_id/orders/$order_id.page.tsx", // $order_id LAYOUT
      },
    ],
    params: {
      customer_id: "123",
