...
// 		{PathBase: router.PathBase{RegisteredPath: &matcher.RegisteredPath{Pattern: "/test1"}}, DataFunction: loader1},
// 		{PathBase: router.PathBase{RegisteredPath: &matcher.RegisteredPath{Pattern: "/test2"}}, DataFunction: loader2},
// 	})
